...
}:
{
  ...
  users.users.alex = {
    ...
    shell = pkgs.fish;
    # SSH auth via the RSA authentication subkeys of the two GPG keys
    # (gpg-agent enableSshSupport) rather than dedicated SSH keypairs.
    openssh.authorizedKeys.keys = [
      "ssh-rsa  openpgp:0x5070F8CB"
