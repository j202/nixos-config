...
in
{
  home = {
    ...
    activation.vscodeArgv = lib.hm.dag.entryAfter [ "writeBoundary" ] ''
  ...
  xdg = {
    ...
    dataFile."libgedit-gtksourceview-300/styles/catppuccin-${flavor}.xml".text = ''
  ...
  dconf.settings."org/gnome/gedit/preferences/editor" = {
    "style-scheme-for-dark-theme-variant" = "catppuccin-${flavor}";
    "style-scheme-for-light-theme-variant" = "catppuccin-${flavor}";
  };
